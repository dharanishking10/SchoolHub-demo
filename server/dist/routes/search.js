...
router.get('/', auth_1.verifyToken, async (req, res) => {
    try {
        ...
        if (!q || q.length < 2) {
            res.json({ success: true, data: { students: [], teachers: [], attendance: [], homework: [], marks: [], announcements: [] } });
            return;
        }
        const role = req.user.role;
        const results = { students: [], teachers: [], attendance: [], homework: [], marks: [], announcements: [] };
