...
import { LogOut, BookOpen, Bell, Award, ClipboardList } from 'lucide-react'
...
export default function StudentDashboard() {
  ...
  const stats = [
    { label: 'Enrolled Courses', value: '0', icon: BookOpen, color: 'bg-blue-100 text-blue-700' },
    { label: 'Assignments', value: '0', icon: ClipboardList, color: 'bg-purple-100 text-purple-700' },
    { label: 'Certifications', value: '0', icon: Award, color: 'bg-green-100 text-green-700' },
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="ml-3 bg-blue-300 text-blue-900 text-xs font-bold px-2 py-0.5 rounded-full">STUDENT</span>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-400 text-center py-8">No courses enrolled yet. Check back soon.</p>
        </div>
      </main>
